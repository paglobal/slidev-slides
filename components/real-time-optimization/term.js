...
function getDefaultParams(mf, range = [0, 1]) {
  ...
  switch (mf) {
    case "triangle":
      args = [
        parseFloat((0.1 * rangeDelta).toFixed(4)),
        parseFloat((0.5 * rangeDelta).toFixed(4)),
        parseFloat((0.9 * rangeDelta).toFixed(4)),
      ];
      break;
    case "trapeze":
      args = [
        parseFloat((0.1 * rangeDelta).toFixed(4)),
        parseFloat((0.4 * rangeDelta).toFixed(4)),
        parseFloat((0.6 * rangeDelta).toFixed(4)),
        parseFloat((0.9 * rangeDelta).toFixed(4)),
      ];
      break;
    case "gauss":
      args = [
        parseFloat((0.17 * rangeDelta).toFixed(4)),
        parseFloat((0.5 * rangeDelta).toFixed(4)),
      ];
      break;
    case "sigma":
      args = [
        parseFloat((18 / rangeDelta).toFixed(4)),
        parseFloat((0.5 * rangeDelta).toFixed(4)),
      ];
      break;
    case "singleton":
      args = [parseFloat((0.5 * rangeDelta).toFixed(4))];
      break;
    default:
